...
<div class="bi-home-banner-section newShop">
    <div class="bi-banner-content">
        <div class="container bi-banner-content-container shop">
            <!-- top logo -->
             <a href="index.html">
            ...
            <div class="bi-banner-headings adjust">
                <h2 class="bi-headline-text">Your Health, Our Priority</h2>

                <div class="bi-banner-btns shop">
                    <a href="#" class="bi-banner-schedule-btn"> Shop Now </a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Stationary Solutions section starts -->
<div class="bi-common-section bi-home-private-use-section">
    ...
    <div class="container bi-conmmon-container">
        ...
        <div class="bi-home-private-use-contents">
            <div class="bi-common-section-content-headings shops">
                <h4 class="bi-common-section-content-heading">Stationary Solutions</h4>
                        ...
                        <div class="bi-common-card-bottom">
                            <div class="bi-common-card-info">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M17.5538 6.42266L2.14431 21.8321" stroke="#02CC78" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9.01675 6.44003L17.5544 6.42165L17.5367 14.96" stroke="#02CC78"
...
<!-- Stationary Solutions section ends -->
...
<div class="bi-common-section bi-home-property-section">
    ...
    <div class="container bi-conmmon-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="1116" height="2" viewBox="0 0 1116 2" fill="none">
            <path d="M1 1H1115" stroke="#DFE3E8" stroke-width="2" stroke-linecap="round" />
        </svg>
    </div>
</div>
...
<!-- Service And Filter Changes section starts -->
<section class="serviceAnd--changes--wrapper">
    <div class="container">
        <div class="serviceAndfilter--header">
            <h3 class="bi-common-section-content-heading">Service And Filter Changes</h3>
            <p class="bi-common-section-content-subheading">Lorem Ipsum is simply dummy text of the printing and
                typesetting industry.</p>
        </div>
        <div class="serviceAndfilter--wrapper">
            <div class="serviceAndfilter--item">
                <!-- card -->
                <a href="#">
                    <div class="bi-common-card">
