    ...
    <div class="sign--in--inner">
        <div class="sign--in--left">
            <div class="sign--in--image">
                <img src="{{asset('frontend/pure-water/assets/images/signInPhoto.png')}}" alt="not found">
            </div>
        </div>
                    ...
                    <div class="nr--email--and--password--wrapper">
                        <div class="nr--email--input--main">
                            ...
                            <div class="nr--email--input">
                                <input type="text" id="userName" name="userName" placeholder="saklainsarowor">
                            </div>
                        </div>
                        ...
                        <div class="nr--email--input--main">
                            ...
                            <div class="nr--email--input">
                                <input type="email" id="email" name="email" placeholder="saklainsarowor">
                            </div>
                        </div>
                        ...
                        <div class="nr--email--input--main">
                            <label for="password">
                                <span class="input--lebel--text">Confirm password</span>
                            </label>
